...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <li>Precisa economizar pois ainda não encontrou trabalho e é sustentada pelos pais</li>
     </td>
    <td>
    ...
    <td>
      <ul>
        ...
        <li> Ambiente seguro </li> <!-- Motivações -->
        <li> Conquistar o cargo dos sonhos </li> <!-- Motivações -->
      </ul>
    </td>
    <td>
      <li> Não teve experiências boas em repúblicas anteriores </li> <!-- Frustações -->
    ...
    <td>
      <li> Ler </li> 
      <li> Cozinhar </li> 
      <li> É natural de Barcelona, se mudou para o Brasil para um mestrado e desde então mora em uma república </li> 
      <li> Acredita que morar em um ambiente acolhedor e funcional não é apenas importante para o seu próprio bem estar mas também para o conforto de outros moradores </li>
    </td>
  </tr>
</table>
...
| Pedro Silva <br> Usuário Demandante | Encontrar uma república | Morar próximo a faculdadee diminuir gastos com transporte |
| Pedro Silva <br> Usuário Demandante | Morar em um local calmo e seguro | Conseguir estudar melhor e sentir seguro no local |
